		...
		<form method="POST" id="form" action="#">
			<table class="form">
				...
				<tr>
					...
					<td><input type="text" name="showdate" id="showdate"/></td>
				</tr>
				<tr>
				...
				<tr>
					<th></th>
					<td><img id="uplaodImg" src="" style="max-width:200px; max-height:200px"></td>
				</tr>
				<tr>
					<th><span class="red">*</span> 漫画描述</th>
					<td><textarea name="description" id="description" rows="8" style="width: 800px; height: 200px;"></textarea></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>
						...
						foreach($typelist as $_type){ 
							if($n%7 == 0){ ?><br/>
							<?php } ?>
							<?php echo $_type->type; ?><input type="checkbox" value="<?php echo $_type->type; ?>" name="typename" />&nbsp&nbsp&nbsp
						<?php 
						$n++;
						} ?>
						<br/>
...
function submitForm()
{
	...
	$.ajax( {
		...
		success:function(data) { 
			...
			if(msg === "success"){
				$('#showmsg').html("创建漫画成功");
				window.location.href="comiclist";
			}else{
				$('#showmsg').html(msg);
			}
		}
